    ...
    var calc_action_points = function() {
        getAttrs(["dex_base", "dex_training", "dex_ageing", "dex_other", "dex_temp", "int_base", "int_training", "int_ageing", "int_other", "int_temp", "pow_base", "pow_training", "pow_ageing", "pow_other", "pow_temp", "action_points_temp", "action_points_other", "action_points_add_one", "fatigue", "spirit", "spirit_ap", "spirit_ap_max", "action_points_calc", "action_points", "action_points_max", "action_points_mook1", "action_points_mook2", "action_points_mook3", "action_points_mook4", "action_points_mook5", "action_points_mook6", "action_points_mook7", "action_points_mook8", "action_points_mook9", "action_points_mook10"], function(v) {
            var dex = parseInt(v.dex_base) + parseInt(v.dex_training) + parseInt(v.dex_ageing) + parseInt(v.dex_other) + parseInt(v.dex_temp);
            var int = parseInt(v.int_base) + parseInt(v.int_training) + parseInt(v.int_ageing) + parseInt(v.int_other) + parseInt(v.int_temp);
            var pow = parseInt(v.pow_base) + parseInt(v.pow_training) + parseInt(v.pow_ageing) + parseInt(v.pow_other) + parseInt(v.pow_temp);
            ...
            if (v["action_points_calc"] == "set_2") {
                ...
                if(v["spirit"] == "1") {
                    var spirit_ap_base = Math.ceil((int + pow) / 12);
                    var base_value = spirit_ap_base;
                } else {
                    var base_value = Math.ceil((int + dex) / 12);
                    var spirit_ap_base = Math.ceil((int + pow) / 12);
                }
            } 
    ...
    on("change:dex_base change:dex_training change:dex_ageing change:dex_other change:dex_temp change:int_base change:int_training change:int_ageing change:int_other change:int_temp change:pow_base change:pow_training change:pow_ageing change:pow_other change:pow_temp change:action_points_temp change:action_points_add_one change:action_points_other change:fatigue change:spirit change:action_points_calc", function() { calc_action_points(); });


    // Spirit Damage Auto Calc + spirit_pow_max
    var calc_spirit_damage = function() {
        getAttrs(["willpower_experience", "willpower_other", "willpower_temp", "binding_learned", "binding_base", "binding_experience", "binding_other", "binding_temp", "pow_base", "pow_training", "pow_ageing", "pow_other", "pow_temp", "cha_base", "cha_training", "cha_ageing", "cha_other", "cha_temp"], function(v) {
            var pow = parseInt(v.pow_base) + parseInt(v.pow_training) + parseInt(v.pow_ageing) + parseInt(v.pow_other) + parseInt(v.pow_temp);
            var cha = parseInt(v.cha_base) + parseInt(v.cha_training) + parseInt(v.cha_ageing) + parseInt(v.cha_other) + parseInt(v.cha_temp);

            var binding = (parseInt(v.binding_learned) * (pow + cha)) + parseInt(v.binding_experience) + parseInt(v.binding_other) + parseInt(v.binding_temp);
    ...
    on("change:willpower_experience change:willpower_other change:willpower_temp change:binding_learned change:binding_base change:binding_experience change:binding_other change:binding_temp change:pow_base change:pow_training change:pow_ageing change:pow_other change:pow_temp change:cha_base change:cha_training change:cha_ageing change:cha_other change:cha_temp", function() { calc_spirit_damage(); });
    
    // Damage Mod Auto Calc
    var calc_damage_mod = function() {
        getAttrs(["str_base", "str_training", "str_ageing", "str_other", "str_temp", "siz_base", "siz_other", "siz_temp", "pow_base", "pow_training", "pow_ageing", "pow_other", "pow_temp", "damage_mod_add_pow", "damage_mod_other", "damage_mod_temp"], function(v) {
            var str = parseInt(v.str_base) + parseInt(v.str_training) + parseInt(v.str_ageing) + parseInt(v.str_other) + parseInt(v.str_temp);
            var siz = parseInt(v.siz_base) + parseInt(v.siz_other) + parseInt(v.siz_temp);
            var pow = parseInt(v.pow_base) + parseInt(v.pow_training) + parseInt(v.pow_ageing) + parseInt(v.pow_other) + parseInt(v.pow_temp);

            if (v.damage_mod_add_pow == 1) {
                var damage_mod_table_value = str + siz + pow;
            } else {
                var damage_mod_table_value = str + siz;
            }
    ...
    on("change:str_base change:str_training change:str_ageing change:str_other change:str_temp change:siz_base change:siz_other change:siz_temp change:pow_base change:pow_training change:pow_ageing change:pow_other change:pow_temp change:damage_mod_add_pow change:damage_mod_other change:damage_mod_temp", function() { calc_damage_mod(); });
    
    // Experience Mod Auto Calc
    var calc_experience_mod = function() {
        getAttrs(["cha_base", "cha_training", "cha_ageing", "cha_other", "cha_temp", "experience_mod_other", "experience_mod_temp"], function(v) {
            var cha = parseInt(v.cha_base) + parseInt(v.cha_training) + parseInt(v.cha_ageing) + parseInt(v.cha_other) + parseInt(v.cha_temp);

            var base_value = Math.ceil(cha/6)-2;
    ...
    on("change:cha_base change:cha_training change:cha_ageing change:cha_other change:cha_temp change:experience_mod_temp change:experience_mod_other", function() { calc_experience_mod(); });

    // Healing Rate Auto Calc
    var calc_healing_rate = function() { 
        getAttrs(["con_base", "con_training", "con_ageing", "con_other", "con_temp", "healing_rate_other", "healing_rate_temp", "healing_rate_double"], function(v) {
            var con = parseInt(v.con_base) + parseInt(v.con_training) + parseInt(v.con_ageing) + parseInt(v.con_other) + parseInt(v.con_temp);

            if (v.healing_rate_double == "1") {
                var base_value = Math.ceil(con/6)*2;
            } else {
                var base_value = Math.ceil(con/6);
            }
    ...
    on("change:healing_rate_temp change:healing_rate_other change:con_base change:con_training change:con_ageing change:con_other change:con_temp change:healing_rate_double", function() { calc_healing_rate(); });
    
    // Initiative Auto Calc
    var calc_initiative = function() {
        getAttrs(["dex_base", "dex_training", "dex_ageing", "dex_other", "dex_temp", "int_base", "int_training", "int_ageing", "int_other", "int_temp", "cha_base", "cha_training", "cha_ageing", "cha_other", "cha_temp", "initiative_bonus_temp", "armor_penalty", "fatigue", "initiative_bonus_other", "spirit"], function(v) {
            var dex = parseInt(v.dex_base) + parseInt(v.dex_training) + parseInt(v.dex_ageing) + parseInt(v.dex_other) + parseInt(v.dex_temp);
            var int = parseInt(v.int_base) + parseInt(v.int_training) + parseInt(v.int_ageing) + parseInt(v.int_other) + parseInt(v.int_temp);
            var cha = parseInt(v.cha_base) + parseInt(v.cha_training) + parseInt(v.cha_ageing) + parseInt(v.cha_other) + parseInt(v.cha_temp);

            if(v["spirit"] == "1") {
                var base_value = Math.ceil((int + cha) / 2);
                var spirit_ib = base_value;
            } else {
                var base_value = Math.ceil((int + dex) / 2);
                var spirit_ib = Math.ceil((int + cha) / 2);
            }
    ...
    on("change:dex_base change:dex_training change:dex_ageing change:dex_other change:dex_temp change:int_base change:int_training change:int_ageing change:int_other change:int_temp change:cha_base change:cha_training change:cha_ageing change:cha_other change:cha_temp change:initiative_bonus_temp change:armor_penalty change:fatigue change:initiative_bonus_other change:spirit", function() { calc_initiative(); });
    ...
    var calc_spirit_intensity = function() {
        getAttrs(["pow_base", "pow_training", "pow_ageing", "pow_other", "pow_temp"], function(v) {
            ...
            setAttrs({ spirit_intensity: Math.ceil(pow/6) });
        });
    };
    on("change:pow_base change:pow_training change:pow_ageing change:pow_other change:pow_temp", function() { calc_spirit_intensity(); });
    
    // Luck Points Auto Calc
    var calc_luck_points = function() {
        getAttrs(["pow_base", "pow_training", "pow_ageing", "pow_other", "pow_temp", "luck_points_temp", "luck_points_other", "luck_points_rank", "rank", "luck_points", "luck_points_max"], function(v) {
            var pow = parseInt(v.pow_base) + parseInt(v.pow_training) + parseInt(v.pow_ageing) + parseInt(v.pow_other) + parseInt(v.pow_temp);

            if (v.luck_points_rank == "1") {
                var base_value = Math.ceil(pow/6) + parseInt(v.rank);
            } else {
                var base_value = Math.ceil(pow/6);
            }
    ...
    on("change:pow_base change:pow_training change:pow_ageing change:pow_other change:pow_temp change:luck_points_temp change:luck_points_other change:luck_points_rank change:rank", function() { calc_luck_points(); });

    
    // Magic Points Auto Calc
    var calc_magic_points = function() {
        getAttrs(["pow_base", "pow_training", "pow_ageing", "pow_other", "pow_temp", "magic_points_temp", "magic_points_other", "magic_points", "magic_points_max", "magic_points_mook1", "magic_points_mook2", "magic_points_mook3", "magic_points_mook4", "magic_points_mook5", "magic_points_mook6", "magic_points_mook7", "magic_points_mook8", "magic_points_mook9", "magic_points_mook10"], function(v) {
            var pow = parseInt(v.pow_base) + parseInt(v.pow_training) + parseInt(v.pow_ageing) + parseInt(v.pow_other) + parseInt(v.pow_temp);

            var new_magic_points_max = pow + parseInt(v.magic_points_temp) + parseInt(v.magic_points_other);
    ...
    on("change:pow_base change:pow_training change:pow_ageing change:pow_other change:pow_temp change:magic_points_temp change:magic_points_other", function() { calc_magic_points(); });

    // Movement Auto Calc 
    var calc_movement = function() {
        getAttrs(["height", "fatigue", "movement_rate_species", "movement_rate_enc", "movement_rate_species_swim", "movement_rate_species_fly", "movement_rate_other", "movement_rate_temp", "armor_penalty", "athletics_experience", "athletics_other", "athletics_temp", "str_base", "str_training", "str_ageing", "str_other", "str_temp", "dex_base", "dex_training", "dex_ageing", "dex_other", "dex_temp", "con_base", "con_training", "con_ageing", "con_other", "con_temp", "swim_experience", "swim_other", "swim_temp"], function(v) {
            var dex = parseInt(v.dex_base) + parseInt(v.dex_training) + parseInt(v.dex_ageing) + parseInt(v.dex_other) + parseInt(v.dex_temp);
            var str = parseInt(v.str_base) + parseInt(v.str_training) + parseInt(v.str_ageing) + parseInt(v.str_other) + parseInt(v.str_temp);
            var con = parseInt(v.con_base) + parseInt(v.con_training) + parseInt(v.con_ageing) + parseInt(v.con_other) + parseInt(v.con_temp);

            var swim_no_penalty = (str + con + parseInt(v.swim_experience)+parseInt(v.swim_other)+parseInt(v.swim_temp));
            ...
            var athletics_no_penalty = (str+dex+parseInt(v.athletics_experience)+parseInt(v.athletics_other)+parseInt(v.athletics_temp));
    ...
    on("change:pow_base change:pow_training change:pow_ageing change:pow_other change:pow_temp change:power_points_temp change:power_points_other", function() { calc_power_points(); });

    // Prana Points Auto Calc
    var calc_prana_points = function() {
        getAttrs(["pow_base", "pow_training", "pow_ageing", "pow_other", "pow_temp", "prana_points_temp", "prana_points_other", "prana_points", "prana_points_max", "prana_points_mook1", "prana_points_mook2", "prana_points_mook3", "prana_points_mook4", "prana_points_mook5", "prana_points_mook6", "prana_points_mook7", "prana_points_mook8", "prana_points_mook9", "prana_points_mook10"], function(v) {
            var pow = parseInt(v.pow_base) + parseInt(v.pow_training) + parseInt(v.pow_ageing) + parseInt(v.pow_other) + parseInt(v.pow_temp);

            var new_prana_points_max = pow + parseInt(v.prana_points_temp) + parseInt(v.prana_points_other);
            var diff_prana_points_max = new_prana_points_max - parseInt(v.prana_points_max);

            setAttrs({
                prana_points_base: pow,
    ...
    on("change:pow_base change:pow_training change:pow_ageing change:pow_other change:pow_temp change:prana_points_temp change:prana_points_other", function() { calc_prana_points(); });
    ...
    var calc_tenacity = function() {
        ...
        getSectionIDs("repeating_dependency", function(idarray) {
            ...
            getAttrs(["pow_base", "pow_training", "pow_ageing", "pow_other", "pow_temp", "tenacity_temp", "tenacity_other", "apply_dependencies_penalty", "tenacity_max", "tenacity", "tenacity_mook1", "tenacity_mook2", "tenacity_mook3", "tenacity_mook4", "tenacity_mook5", "tenacity_mook6", "tenacity_mook7", "tenacity_mook8", "tenacity_mook9", "tenacity_mook10"], function(val) {
                var pow = parseInt(v.pow_base) + parseInt(v.pow_training) + parseInt(v.pow_ageing) + parseInt(v.pow_other) + parseInt(v.pow_temp);
    ...
    on("change:pow_base change:pow_training change:pow_ageing change:pow_other change:pow_temp change:tenacity_temp change:tenacity_other change:apply_dependencies_penalty change:repeating_dependency remove:repeating_dependency", function() { calc_tenacity(); });

    // HP & Armor Auto Calc
    var calc_hp_max_base = function() {
        getAttrs(["con_base", "con_training", "con_ageing", "con_other", "con_temp", "siz_base", "siz_other", "siz_temp", "pow_base", "pow_training", "pow_ageing", "pow_other", "pow_temp", "hp_use_pow"], function(v) {
            var con = parseInt(v.con_base) + parseInt(v.con_training) + parseInt(v.con_ageing) + parseInt(v.con_other) + parseInt(v.con_temp);
            var siz = parseInt(v.siz_base) + parseInt(v.siz_other) + parseInt(v.siz_temp);
            var pow = parseInt(v.pow_base) + parseInt(v.pow_training) + parseInt(v.pow_ageing) + parseInt(v.pow_other) + parseInt(v.pow_temp);

            base_value = Math.ceil( (con + siz + (pow * parseInt(v.hp_use_pow)))/5 );
    ...
    on("change:con_base change:con_training change:con_ageing change:con_other change:con_temp change:siz_base change:siz_other change:siz_temp change:pow_base change:pow_training change:pow_ageing change:pow_other change:pow_temp change:hp_use_pow", function() { calc_hp_max_base(); });
    ...
    var calc_simplified_hp = function() {
        getAttrs(["con_base", "con_training", "con_ageing", "con_other", "con_temp", "siz_base", "siz_other", "siz_temp", "pow_base", "pow_training", "pow_ageing", "pow_other", "pow_temp", "hp_use_pow", "simplified_hp_max_other", "all_hp_temp", "simplified_hp", "simplified_hp_max", "simplified_hp_mook1", "simplified_hp_mook2", "simplified_hp_mook3", "simplified_hp_mook4", "simplified_hp_mook5", "simplified_hp_mook6", "simplified_hp_mook7", "simplified_hp_mook8", "simplified_hp_mook9", "simplified_hp_mook10", "simplified_hp_mook11", "simplified_hp_mook12"], function(v) {
            var con = parseInt(v.con_base) + parseInt(v.con_training) + parseInt(v.con_ageing) + parseInt(v.con_other) + parseInt(v.con_temp);
            var siz = parseInt(v.siz_base) + parseInt(v.siz_other) + parseInt(v.siz_temp);
            var pow = parseInt(v.pow_base) + parseInt(v.pow_training) + parseInt(v.pow_ageing) + parseInt(v.pow_other) + parseInt(v.pow_temp);

            base_value = Math.ceil( (con + siz + (pow * parseInt(v.hp_use_pow)))/2 );
    ...
    on("change:con_base change:con_training change:con_ageing change:con_other change:con_temp change:siz_base change:siz_other change:siz_temp change:pow_base change:pow_training change:pow_ageing change:pow_other change:pow_temp change:hp_use_pow change:simplified_hp_max_other change:all_hp_temp", function() { calc_simplified_hp(); });

    // Fatigue Auto Calc
    var calc_fatigue = function() {
        getAttrs(["fatigue", "healing_rate"], function(v) {
            var healing_rate = parseInt(v.healing_rate);
            if (v.fatigue == "9") {
                setAttrs({
                    fatigue_skills: '0',
    ...
    var calc_skill = function(skill_name, char1, char2, learned) {
        ...
        getAttrs(["str_base", "str_training", "str_ageing", "str_other", "str_temp", "con_base", "con_training", "con_ageing", "con_other", "con_temp", "siz_base", "siz_other", "siz_temp", "dex_base", "dex_training", "dex_ageing", "dex_other", "dex_temp", "int_base", "int_training", "int_ageing", "int_other", "int_temp", "pow_base", "pow_training", "pow_ageing", "pow_other", "pow_temp", "cha_base", "cha_training", "cha_ageing", "cha_other", "cha_temp", skill_base, skill_xp, skill_temp, skill_other, skill_penalty, "herculean_mod"], function(v) {
            var str = parseInt(v.str_base) + parseInt(v.str_training) + parseInt(v.str_ageing) + parseInt(v.str_other) + parseInt(v.str_temp);
            var con = parseInt(v.con_base) + parseInt(v.con_training) + parseInt(v.con_ageing) + parseInt(v.con_other) + parseInt(v.con_temp);
            var siz = parseInt(v.siz_base) + parseInt(v.siz_other) + parseInt(v.siz_temp);
            var dex = parseInt(v.dex_base) + parseInt(v.dex_training) + parseInt(v.dex_ageing) + parseInt(v.dex_other) + parseInt(v.dex_temp);
    ...
    var calc_arcane_casting_derived = function() {
        getAttrs(["int_base", "int_training", "int_ageing", "int_other", "int_temp", "pow_base", "pow_training", "pow_ageing", "pow_other", "pow_temp", "arcane_casting_experience", "arcane_casting_temp", "arcane_casting_other", "arcane_casting_learned"], function(v) {
            var int = parseInt(v.int_base) + parseInt(v.int_training) + parseInt(v.int_ageing) + parseInt(v.int_other) + parseInt(v.int_temp);
            var pow = parseInt(v.pow_base) + parseInt(v.pow_training) + parseInt(v.pow_ageing) + parseInt(v.pow_other) + parseInt(v.pow_temp);

            var arcane_casting = parseInt(v.arcane_casting_learned) * (int + pow) + parseInt(v.arcane_casting_experience) + parseInt(v.arcane_casting_temp) + parseInt(v.arcane_casting_other);
            setAttrs({
    ...
    var calc_arcane_knowledge_derived = function() {
        getAttrs(["int_base", "int_training", "int_ageing", "int_other", "int_temp", "arcane_knowledge_experience", "arcane_knowledge_temp", "arcane_knowledge_other", "arcane_knowledge_learned"], function(v) {
            var int = parseInt(v.int_base) + parseInt(v.int_training) + parseInt(v.int_ageing) + parseInt(v.int_other) + parseInt(v.int_temp);

            var arcane_knowledge = parseInt(v.arcane_knowledge_learned) * (int + int) + parseInt(v.arcane_knowledge_experience) + parseInt(v.arcane_knowledge_temp) + parseInt(v.arcane_knowledge_other);
            setAttrs({
    ...
    var calc_channel_derived = function() {
        getAttrs(["int_base", "int_training", "int_ageing", "int_other", "int_temp", "cha_base", "cha_training", "cha_ageing", "cha_other", "cha_temp", "channel_experience", "channel_temp", "channel_other", "channel_learned"], function(v) {
            var int = parseInt(v.int_base) + parseInt(v.int_training) + parseInt(v.int_ageing) + parseInt(v.int_other) + parseInt(v.int_temp);
            var cha = parseInt(v.cha_base) + parseInt(v.cha_training) + parseInt(v.cha_ageing) + parseInt(v.cha_other) + parseInt(v.cha_temp);

            var channel = parseInt(v.channel_learned) * (int + cha) + parseInt(v.channel_experience) + parseInt(v.channel_temp) + parseInt(v.channel_other);
            setAttrs({
    ...
    var calc_fata_derived = function() {
        getAttrs(["pow_base", "pow_training", "pow_ageing", "pow_other", "pow_temp", "cha_base", "cha_training", "cha_ageing", "cha_other", "cha_temp", "fata_experience", "fata_temp", "fata_other", "fata_learned"], function(v) {
            var pow = parseInt(v.pow_base) + parseInt(v.pow_training) + parseInt(v.pow_ageing) + parseInt(v.pow_other) + parseInt(v.pow_temp);
            var cha = parseInt(v.cha_base) + parseInt(v.cha_training) + parseInt(v.cha_ageing) + parseInt(v.cha_other) + parseInt(v.cha_temp);

            var fata = parseInt(v.fata_learned) * (pow + cha) + parseInt(v.fata_experience) + parseInt(v.fata_temp) + parseInt(v.fata_other);
    ...
    on("change:pow_base change:pow_training change:pow_ageing change:pow_other change:pow_temp change:int_base change:int_training change:int_ageing change:int_other change:int_temp change:arcane_casting_experience change:arcane_casting_other change:arcane_casting_temp change:arcane_casting_penalty change:arcane_casting_learned change:herculean_mod ", function() {
    ...
    on("change:int_base change:int_training change:int_ageing change:int_other change:int_temp change:arcane_knowledge_experience change:arcane_knowledge_other change:arcane_knowledge_temp change:arcane_knowledge_penalty change:arcane_knowledge_learned change:herculean_mod ", function() {
    ...
    on("change:str_base change:str_training change:str_ageing change:str_other change:str_temp change:dex_base change:dex_training change:dex_ageing change:dex_other change:dex_temp change:athletics_experience change:athletics_other change:athletics_temp change:athletics_penalty change:herculean_mod ", function() { calc_skill("athletics", "@{str}", "@{dex}", 1); });
    on("change:cha_base change:cha_training change:cha_ageing change:cha_other change:cha_temp change:pow_base change:pow_training change:pow_ageing change:pow_other change:pow_temp change:binding_experience change:binding_other change:binding_temp change:binding_penalty change:binding_learned change:herculean_mod ", function() {
        getAttrs(["binding_learned"], function(v) {
            calc_skill("binding", "@{cha}", "@{pow}", v.binding_learned);
        });    
    });
    on("change:str_base change:str_training change:str_ageing change:str_other change:str_temp change:con_base change:con_training change:con_ageing change:con_other change:con_temp change:boating_experience change:boating_other change:boating_temp change:boating_penalty change:herculean_mod ", function() { calc_skill("boating", "@{str}", "@{con}", 1); });
    on("change:str_base change:str_training change:str_ageing change:str_other change:str_temp change:siz_base change:siz_other change:siz_temp change:brawn_experience change:brawn_other change:brawn_temp change:brawn_penalty change:herculean_mod ", function() { calc_skill("brawn", "@{str}", "@{siz}", 1); });
    on("change:cha_base change:cha_training change:cha_ageing change:cha_other change:cha_temp change:int_base change:int_training change:int_ageing change:int_other change:int_temp change:channel_experience change:channel_other change:channel_temp change:channel_penalty change:channel_learned change:herculean_mod ", function() {
        getAttrs(["channel_learned"], function(v) {
            calc_skill("channel", "@{cha}", "@{int}", v.channel_learned);
            calc_channel_derived();
        });    
    });
    on("change:dex_base change:dex_training change:dex_ageing change:dex_other change:dex_temp change:pow_base change:pow_training change:pow_ageing change:pow_other change:pow_temp change:conceal_experience change:conceal_other change:conceal_temp change:conceal_penalty change:herculean_mod ", function() { calc_skill("conceal", "@{dex}", "@{pow}", 1); });
    on("change:pow_base change:pow_training change:pow_ageing change:pow_other change:pow_temp change:cha_base change:cha_training change:cha_ageing change:cha_other change:cha_temp change:cursing_experience change:cursing_other change:cursing_temp change:cursing_penalty change:cursing_learned change:herculean_mod ", function() {
        getAttrs(["cursing_learned"], function(v) {
            calc_skill("cursing", "@{pow}", "@{cha}", v.cursing_learned);
        });    
    });
    on("change:int_base change:int_training change:int_ageing change:int_other change:int_temp change:customs_experience change:customs_other change:customs_temp change:customs_penalty change:herculean_mod ", function() { calc_skill("customs", "@{int}", "@{int}", 1); });
    on("change:dex_base change:dex_training change:dex_ageing change:dex_other change:dex_temp change:cha_base change:cha_training change:cha_ageing change:cha_other change:cha_temp change:dance_experience change:dance_other change:dance_temp change:dance_penalty change:herculean_mod ", function() { calc_skill("dance", "@{cha}", "@{dex}", 1); });
    on("change:int_base change:int_training change:int_ageing change:int_other change:int_temp change:cha_base change:cha_training change:cha_ageing change:cha_other change:cha_temp change:deceit_experience change:deceit_other change:deceit_temp change:deceit_penalty change:herculean_mod ", function() { calc_skill("deceit", "@{int}", "@{cha}", 1); });
    on("change:pow_base change:pow_training change:pow_ageing change:pow_other change:pow_temp change:int_base change:int_training change:int_ageing change:int_other change:int_temp change:divination_experience change:divination_other change:divination_temp change:divination_penalty change:divination_learned change:herculean_mod ", function() {
        getAttrs(["divination_learned"], function(v) {
            calc_skill("divination", "@{pow}", "@{int}", v.divination_learned);
        });    
    });
    on("change:dex_base change:dex_training change:dex_ageing change:dex_other change:dex_temp change:pow_base change:pow_training change:pow_ageing change:pow_other change:pow_temp change:drive_experience change:drive_other change:drive_temp change:drive_penalty change:herculean_mod ", function() { calc_skill("drive", "@{dex}", "@{pow}", 1); });
    on("change:con_base change:con_training change:con_ageing change:con_other change:con_temp change:endurance_experience change:endurance_other change:endurance_temp change:endurance_penalty change:herculean_mod ", function() { calc_skill("endurance", "@{con}", "@{con}", 1); });
    on("change:dex_base change:dex_training change:dex_ageing change:dex_other change:dex_temp change:evade_experience change:evade_other change:evade_temp change:evade_penalty change:herculean_mod ", function() { calc_skill("evade", "@{dex}", "@{dex}", 1); });
    on("change:cha_base change:cha_training change:cha_ageing change:cha_other change:cha_temp change:int_base change:int_training change:int_ageing change:int_other change:int_temp change:exhort_experience change:exhort_other change:exhort_temp change:exhort_penalty change:exhort_learned change:herculean_mod ", function() {
        getAttrs(["exhort_learned"], function(v) {
            calc_skill("exhort", "@{cha}", "@{int}", v.exhort_learned);
        });    
    });
    on("change:cha_base change:cha_training change:cha_ageing change:cha_other change:cha_temp change:pow_base change:pow_training change:pow_ageing change:pow_other change:pow_temp change:fata_experience change:fata_other change:fata_temp change:fata_penalty change:fata_learned change:herculean_mod ", function() {
        getAttrs(["fata_learned"], function(v) {
            calc_skill("fata", "@{cha}", "@{pow}", v.fata_learned);
            calc_fata_derived();
        });    
    });
    on("change:int_base change:int_training change:int_ageing change:int_other change:int_temp change:dex_base change:dex_training change:dex_ageing change:dex_other change:dex_temp change:first_aid_experience change:first_aid_other change:first_aid_temp change:first_aid_penalty change:herculean_mod ", function() { calc_skill("first_aid", "@{int}", "@{dex}", 1); });
    on("change:cha_base change:cha_training change:cha_ageing change:cha_other change:cha_temp change:pow_base change:pow_training change:pow_ageing change:pow_other change:pow_temp change:folk_magic_experience change:folk_magic_other change:folk_magic_temp change:folk_magic_penalty change:folk_magic_learned change:herculean_mod ", function() {
        getAttrs(["folk_magic_learned"], function(v) {
            calc_skill("folk_magic", "@{cha}", "@{pow}", v.folk_magic_learned);
        });    
    });
    on("change:int_base change:int_training change:int_ageing change:int_other change:int_temp change:home_parallel_experience change:home_parallel_other change:home_parallel_temp change:home_parallel_penalty change:herculean_mod ", function() { calc_skill("home_parallel", "@{int}", "@{int}", 1); });
    on("change:cha_base change:cha_training change:cha_ageing change:cha_other change:cha_temp change:influence_experience change:influence_other change:influence_temp change:influence_penalty change:herculean_mod ", function() { calc_skill("influence", "@{cha}", "@{cha}", 1); });
    on("change:int_base change:int_training change:int_ageing change:int_other change:int_temp change:pow_base change:pow_training change:pow_ageing change:pow_other change:pow_temp change:insight_experience change:insight_other change:insight_temp change:insight_penalty change:herculean_mod ", function() { calc_skill("insight", "@{int}", "@{pow}", 1); });
    on("change:int_base change:int_training change:int_ageing change:int_other change:int_temp change:cha_base change:cha_training change:cha_ageing change:cha_other change:cha_temp change:linguistics_experience change:linguistics_other change:linguistics_temp change:linguistics_penalty change:linguistics_learned change:herculean_mod ", function() {
        getAttrs(["linguistics_learned"], function(v) {
            calc_skill("linguistics", "@{cha}", "@{int}", v.linguistics_learned);
        });    
    });
    on("change:int_base change:int_training change:int_ageing change:int_other change:int_temp change:locale_experience change:locale_other change:locale_temp change:locale_penalty change:herculean_mod ", function() { calc_skill("locale", "@{int}", "@{int}", 1); });
    on("change:int_base change:int_training change:int_ageing change:int_other change:int_temp change:con_base change:con_training change:con_ageing change:con_other change:con_temp change:meditation_experience change:meditation_other change:meditation_temp change:meditation_penalty change:meditation_learned change:herculean_mod ", function() {
        getAttrs(["meditation_learned"], function(v) {
            calc_skill("meditation", "@{con}", "@{int}", v.meditation_learned);
        });    
    });
    on("change:int_base change:int_training change:int_ageing change:int_other change:int_temp change:cha_base change:cha_training change:cha_ageing change:cha_other change:cha_temp change:native_tongue_experience change:native_tongue_other change:native_tongue_temp change:native_tongue_penalty change:herculean_mod ", function() { calc_skill("native_tongue", "@{int}", "@{cha}", 1); });
    on("change:cha_base change:cha_training change:cha_ageing change:cha_other change:cha_temp change:int_base change:int_training change:int_ageing change:int_other change:int_temp change:necromancy_experience change:necromancy_other change:necromancy_temp change:necromancy_penalty change:necromancy_learned change:herculean_mod ", function() {
        getAttrs(["necromancy_learned"], function(v) {
            calc_skill("necromancy", "@{cha}", "@{int}", v.necromancy_learned);
        });    
    });
    on("change:int_base change:int_training change:int_ageing change:int_other change:int_temp change:pharmacy_experience change:pharmacy_other change:pharmacy_temp change:pharmacy_penalty change:pharmacy_learned change:herculean_mod ", function() {
        getAttrs(["pharmacy_learned"], function(v) {
            calc_skill("pharmacy", "@{int}", "@{int}", v.pharmacy_learned);
        });    
    });
    on("change:cha_base change:cha_training change:cha_ageing change:cha_other change:cha_temp change:pow_base change:pow_training change:pow_ageing change:pow_other change:pow_temp change:piety_experience change:piety_other change:piety_temp change:piety_penalty change:piety_learned change:herculean_mod ", function() {
        getAttrs(["piety_learned"], function(v) {
            calc_skill("piety", "@{cha}", "@{pow}", v.piety_learned);
        });    
    });
    on("change:int_base change:int_training change:int_ageing change:int_other change:int_temp change:pow_base change:pow_training change:pow_ageing change:pow_other change:pow_temp change:perception_experience change:perception_other change:perception_temp change:perception_penalty change:herculean_mod ", function() { calc_skill("perception", "@{int}", "@{pow}", 1); });
    on("change:dex_base change:dex_training change:dex_ageing change:dex_other change:dex_temp change:pow_base change:pow_training change:pow_ageing change:pow_other change:pow_temp change:ride_experience change:ride_other change:ride_temp change:ride_penalty change:herculean_mod ", function() { calc_skill("ride", "@{dex}", "@{pow}", 1); });
    on("change:con_base change:con_training change:con_ageing change:con_other change:con_temp change:pow_base change:pow_training change:pow_ageing change:pow_other change:pow_temp change:shape_shifting_experience change:shape_shifting_other change:shape_shifting_temp change:shape_shifting_penalty change:shape_shifting_learned change:herculean_mod ", function() {
        getAttrs(["shape_shifting_learned"], function(v) {
            calc_skill("shape_shifting", "@{con}", "@{pow}", v.shape_shifting_learned);
        });    
    });
    on("change:int_base change:int_training change:int_ageing change:int_other change:int_temp change:pow_base change:pow_training change:pow_ageing change:pow_other change:pow_temp change:shaping_experience change:shaping_other change:shaping_temp change:shaping_penalty change:shaping_learned change:herculean_mod ", function() {
        getAttrs(["shaping_learned"], function(v) {
            calc_skill("shaping", "@{int}", "@{pow}", v.shaping_learned);
        });    
    });
    on("change:cha_base change:cha_training change:cha_ageing change:cha_other change:cha_temp change:pow_base change:pow_training change:pow_ageing change:pow_other change:pow_temp change:sing_experience change:sing_other change:sing_temp change:sing_penalty change:herculean_mod ", function() { calc_skill("sing", "@{cha}", "@{pow}", 1); });
    ...
    on("change:int_base change:int_training change:int_ageing change:int_other change:int_temp change:dex_base change:dex_training change:dex_ageing change:dex_other change:dex_temp change:stealth_experience change:stealth_other change:stealth_temp change:stealth_penalty change:herculean_mod ", function() { calc_skill("stealth", "@{int}", "@{dex}", 1); });
    on("change:int_base change:int_training change:int_ageing change:int_other change:int_temp change:pow_base change:pow_training change:pow_ageing change:pow_other change:pow_temp change:superstition_experience change:superstition_other change:superstition_temp change:superstition_penalty change:herculean_mod ", function() { calc_skill("superstition", "@{int}", "@{pow}", 1); });
    on("change:str_base change:str_training change:str_ageing change:str_other change:str_temp change:con_base change:con_training change:con_ageing change:con_other change:con_temp change:swim_experience change:swim_other change:swim_temp change:swim_penalty change:herculean_mod ", function() { calc_skill("swim", "@{str}", "@{con}", 1); });
    on("change:pow_base change:pow_training change:pow_ageing change:pow_other change:pow_temp change:theology_experience change:theology_other change:theology_temp change:theology_penalty change:theology_learned change:herculean_mod ", function() {
        getAttrs(["theology_learned"], function(v) {
            calc_skill("theology", "@{pow}", "@{pow}", v.theology_learned);
        });    
    });
    on("change:con_base change:con_training change:con_ageing change:con_other change:con_temp change:pow_base change:pow_training change:pow_ageing change:pow_other change:pow_temp change:trance_experience change:trance_other change:trance_temp change:trance_penalty change:trance_learned change:herculean_mod ", function() {
        getAttrs(["trance_learned"], function(v) {
            calc_skill("trance", "@{con}", "@{pow}", v.trance_learned);
        });    
    });
    on("change:str_base change:str_training change:str_ageing change:str_other change:str_temp change:dex_base change:dex_training change:dex_ageing change:dex_other change:dex_temp change:unarmed_experience change:unarmed_other change:unarmed_temp change:unarmed_penalty change:herculean_mod ", function() { calc_skill("unarmed", "@{str}", "@{dex}", 1); });
    on("change:pow_base change:pow_training change:pow_ageing change:pow_other change:pow_temp change:willpower_experience change:willpower_other change:willpower_temp change:willpower_penalty change:herculean_mod ", function() { calc_skill("willpower", "@{pow}", "@{pow}", 1); });
    // Repeating Language Auto Calc
    on("change:int_base change:int_training change:int_ageing change:int_other change:int_temp change:cha_base change:cha_training change:cha_ageing change:cha_other change:cha_temp change:herculean_mod change:repeating_language", function() {
    ...
    on("change:pow_base change:pow_training change:pow_ageing change:pow_other change:pow_temp change:herculean_mod change:repeating_psionicpower", function() {
    ...
    on("change:pow_base change:pow_training change:pow_ageing change:pow_other change:pow_temp change:con_base change:con_training change:con_ageing change:con_other change:con_temp change:herculean_mod change:repeating_path", function() {
    ...
    on("change:pow_base change:pow_training change:pow_ageing change:pow_other change:pow_temp change:herculean_mod change:repeating_discipline", function() {
    ...
    on("change:pow_base change:pow_training change:pow_ageing change:pow_other change:pow_temp change:cha_base change:cha_training change:cha_ageing change:cha_other change:cha_temp change:herculean_mod change:repeating_devotion", function() {
    ...
    on("change:str_base change:str_training change:str_ageing change:str_other change:str_temp change:con_base change:con_training change:con_ageing change:con_other change:con_temp change:siz_base change:siz_other change:siz_temp change:dex_base change:dex_training change:dex_ageing change:dex_other change:dex_temp change:int_base change:int_training change:int_ageing change:int_other change:int_temp change:cha_base change:cha_training change:cha_ageing change:cha_other change:cha_temp change:pow_base change:pow_training change:pow_ageing change:pow_other change:pow_temp change:herculean_mod change:repeating_combatstyle remove:repeating_combatstyle", function(eventInfo) {
    ...
    on("change:str_base change:str_training change:str_ageing change:str_other change:str_temp change:con_base change:con_training change:con_ageing change:con_other change:con_temp change:siz_base change:siz_other change:siz_temp change:dex_base change:dex_training change:dex_ageing change:dex_other change:dex_temp change:int_base change:int_training change:int_ageing change:int_other change:int_temp change:cha_base change:cha_training change:cha_ageing change:cha_other change:cha_temp change:pow_base change:pow_training change:pow_ageing change:pow_other change:pow_temp change:herculean_mod change:repeating_standardskill", function() {
    ...
    on("change:str_base change:str_training change:str_ageing change:str_other change:str_temp change:con_base change:con_training change:con_ageing change:con_other change:con_temp change:siz_base change:siz_other change:siz_temp change:dex_base change:dex_training change:dex_ageing change:dex_other change:dex_temp change:int_base change:int_training change:int_ageing change:int_other change:int_temp change:cha_base change:cha_training change:cha_ageing change:cha_other change:cha_temp change:pow_base change:pow_training change:pow_ageing change:pow_other change:pow_temp change:herculean_mod change:repeating_professionalskill", function() {
    ...
    on("change:str_base change:str_training change:str_ageing change:str_other change:str_temp change:con_base change:con_training change:con_ageing change:con_other change:con_temp change:siz_base change:siz_other change:siz_temp change:dex_base change:dex_training change:dex_ageing change:dex_other change:dex_temp change:int_base change:int_training change:int_ageing change:int_other change:int_temp change:cha_base change:cha_training change:cha_ageing change:cha_other change:cha_temp change:pow_base change:pow_training change:pow_ageing change:pow_other change:pow_temp change:herculean_mod change:repeating_invocation", function() {
    ...
    var calc_max_spirits = function() {
        getAttrs(["cha_base", "cha_training", "cha_ageing", "cha_other", "cha_temp", "animism_cult_rank"], function(v) {
    ...
    on("change:cha_base change:cha_training change:cha_ageing change:cha_other change:cha_temp change:animism_cult_rank", function() { calc_max_spirits(); }); 

    // Recalc
    var recalc_sheet = function() {
        console.log("Recalculating all sheet values!");

        console.log("Recalculating chars");
        ...
        console.log("Recalculating known skills");
        // Recalc Known Skills
        getAttrs(["arcane_casting_learned"], function(v) {
            calc_skill("arcane_casting", "@{int}", "@{pow}", v.arcane_casting_learned);
            calc_arcane_casting_derived();
        ...
        console.log("Recalculating unknown skills");
        ...
        console.log("Recalculating deps and passions");
        ...
        console.log("Recalculating attrs");
        // Recalc Attributes
        calc_action_points();
        calc_spirit_damage();
        calc_damage_mod();
        ...
        console.log("Recalculating other");
        // Recalc Other
        calc_max_spirits();
        calc_movement();
        calc_fatigue();
    ...
    on("change:simplified_combat_enabled", function() {
        getAttrs(["simplified_combat_enabled"], function(v) {
    ...
    on("change:vehicle_size", function() {
        getAttrs(["vehicle_size"], function(v) {
            setAttrs({
                vehicle_system1_hits: v.vehicle_size,
                vehicle_system2_hits: v.vehicle_size,
                vehicle_system3_hits: v.vehicle_size,
                vehicle_system4_hits: v.vehicle_size,
                vehicle_system5_hits: v.vehicle_size,
                vehicle_system6_hits: v.vehicle_size,
                vehicle_system7_hits: v.vehicle_size,
                vehicle_system8_hits: v.vehicle_size,
                vehicle_system9_hits: v.vehicle_size,
                vehicle_system10_hits: v.vehicle_size
            });
        });     
    });    
    
    on("change:mythras_vehicle_type", function() {
        getAttrs(["mythras_vehicle_type"], function(v) {
    ...
    on("change:msvehicle_maneuvering_tr change:msvehicle_engines_tr change:msvehicle_type change:msvehicle_tractor_beam change:msvehicle_storage change:msvehicle_sickbay change:msvehicle_sensors change:msvehicle_self_repair change:msvehicle_robot_arm change:msvehicle_rescue_utilities change:msvehicle_passengers change:msvehicle_open_space change:msvehicle_maneuvering change:msvehicle_lab change:msvehicle_hyperspace change:msvehicle_hanger change:msvehicle_environment change:msvehicle_extra_sensors change:msvehicle_escape_pod change:msvehicle_engines change:msvehicle_crew change:msvehicle_cockpit change:msvehicle_cargo change:msvehicle_airlock change:msvehicle_weapons", function() {
        getAttrs(["msvehicle_engines_tr", "msvehicle_maneuvering_tr", "msvehicle_type", "msvehicle_tractor_beam", "msvehicle_storage", "msvehicle_sickbay", "msvehicle_sensors", "msvehicle_self_repair", "msvehicle_robot_arm", "msvehicle_rescue_utilities", "msvehicle_passengers", "msvehicle_open_space", "msvehicle_maneuvering", "msvehicle_lab", "msvehicle_hyperspace", "msvehicle_hanger", "msvehicle_environment", "msvehicle_extra_sensors", "msvehicle_escape_pod", "msvehicle_engines", "msvehicle_crew", "msvehicle_cockpit", "msvehicle_cargo", "msvehicle_airlock", "msvehicle_weapons"], function(v) {
            var weapons = parseFloat(v.msvehicle_weapons);
            var tractor_beam = parseFloat(v.msvehicle_tractor_beam);
            var storage = parseFloat(v.msvehicle_storage);
            var sickbay = parseFloat(v.msvehicle_sickbay);
            var sensors = parseFloat(v.msvehicle_sensors);
            var self_repair = parseFloat(v.msvehicle_self_repair);
            var robot_arms = parseFloat(v.msvehicle_robot_arm);
            var rescue_utilities = parseFloat(v.msvehicle_rescue_utilities);
            var passengers = parseFloat(v.msvehicle_passengers);
            var open_space = parseFloat(v.msvehicle_open_space);
            var maneuvering = parseFloat(v.msvehicle_maneuvering);
            var lab = parseFloat(v.msvehicle_lab);
            var hyperspace = parseFloat(v.msvehicle_hyperspace);
            var hanger = parseFloat(v.msvehicle_hanger);
            var environment = parseFloat(v.msvehicle_environment);
            var extra_sensors = parseFloat(v.msvehicle_extra_sensors);
            var escape_pod = parseFloat(v.msvehicle_escape_pod);
            var engines = parseFloat(v.msvehicle_engines);
            var crew = parseFloat(v.msvehicle_crew);
            var cockpit = parseFloat(v.msvehicle_cockpit);
            var cargo = parseFloat(v.msvehicle_cargo);
            var airlock = parseFloat(v.msvehicle_airlock);
            
            var engines_tr = parseInt(v.msvehicle_engines_tr);
            var maneuvering_tr = parseInt(v.msvehicle_maneuvering_tr);
            ...
            if (v.msvehicle_type == "spaceship") {
                ...
                visual_size = size * 2;
                sails_toggle = 1;
            } else if (v.msvehicle_type == "sub") {
                var msvehicle_spaceship_toggle = 0;
                var speed = Math.ceil(speed_tr * .5);
                var handling = Math.ceil(handling_tr * .5);
                var size = total_modules * 3 * 10;
            } else if (v.msvehicle_type == "wings") {
                var msvehicle_spaceship_toggle = 0;
                var speed = speed_tr;
                var handling = handling_tr;
                var size = total_modules * 3 * 10;
            } else if (v.msvehicle_type == "anti-grav") {
                var msvehicle_spaceship_toggle = 0;
                var speed = speed_tr;
                var handling = handling_tr;
                var size = (total_modules + Math.ceil(total_modules * .1)) * 10;
            } else if (v.msvehicle_type == "rotor_blades") {
                var msvehicle_spaceship_toggle = 0;
                var speed = speed_tr;
                var handling = handling_tr;
                var size = total_modules * 2 * 10;
            } else if (v.msvehicle_type == "hover_craft") {
                var msvehicle_spaceship_toggle = 0
                var speed = speed_tr;
                var handling = handling_tr;
                var size = total_modules * 2 * 10;
            } else if (v.msvehicle_type == "gas_bag") {
                var msvehicle_spaceship_toggle = 0;
                var speed = speed_tr;
                var handling = handling_tr;
    ...
    on("change:ship_condition", function() {
        getAttrs(["ship_condition", "ship_seaworthiness"], function(v) {
            var ship_range = Math.ceil(v.ship_seaworthiness/10);
            
            if (v.ship_condition == "ship_shape") {
                setAttrs({
            ...
            } else if (v.ship_condition == "seaworthy") {
                setAttrs({
                    ship_condition_skills: '1',
                    ship_speed: '-',
            ...
            } else if (v.ship_condition == "battered") {
                setAttrs({
            ...
            } else if (v.ship_condition == "swamped") {
                setAttrs({
            ...
            } else if (v.ship_condition == "sinking") {
                setAttrs({
    ...
    var calc_enc = function() {
        getAttrs(["avg_species_siz", "str_base", "str_training", "str_ageing", "str_other", "str_temp", "effective_armor_enc", "melee_weapons_enc", "ranged_weapons_enc", "loadout_enc", "pack_enc", "pack_equipped", "currency_enc", "encumbrance_temp"], function(v) {
            var str = parseInt(v.str_base) + parseInt(v.str_training) + parseInt(v.str_ageing) + parseInt(v.str_other) + parseInt(v.str_temp);
            var burdened = str * 2;
    ...
    on("change:avg_species_siz change:str_base change:str_training change:str_ageing change:str_other change:str_temp change:effective_armor_enc change:melee_weapons_enc change:ranged_weapons_enc change:loadout_enc change:pack_enc change:pack_equipped change:currency_enc change:encumbrance_temp", function() { calc_enc(); });
    ...
    on("change:repeating_fetish:fetish_spectral_combat", function() {
        getAttrs(["repeating_fetish_fetish_spectral_combat"], function(v) {
            var spectral_combat = parseInt(v.repeating_fetish_fetish_spectral_combat);
    ...
    on("change:unit_frontage", function() {
        getAttrs(["unit_frontage"], function(v) {
            var frontage = parseInt(v.unit_frontage);
    ...
    on("change:arcane_caster_class change:arcane_magic_rank change:int_base change:int_training change:int_ageing change:int_other change:int_temp", function() {
        getAttrs(["arcane_caster_class", "arcane_magic_rank", "int_base", "int_training", "int_ageing", "int_other", "int_temp"], function(v) {
            var magic_rank = parseInt(v.arcane_magic_rank);
            var int = parseInt(v.int_base) + parseInt(v.int_training) + parseInt(v.int_ageing) + parseInt(v.int_other) + parseInt(v.int_temp);
            var reductionmod = 0;
            var basememorizemax = 0;
            var memorizemod = 0;
            if (v.arcane_caster_class == "magic-user") {
                reductionmod = 2;
                memorizemod = 2;
                basememorizemax = Math.ceil(int/4);
            } else if (v.arcane_caster_class == "bard") {
                reductionmod = 1;
                memorizemod = 1;
    ...
    on("change:divine_caster_class change:divine_magic_rank change:int_base change:int_training change:int_ageing change:int_other change:int_temp", function() {
        getAttrs(["divine_caster_class", "divine_magic_rank", "int_base", "int_training", "int_ageing", "int_other", "int_temp"], function(v) {
            var magic_rank = parseInt(v.divine_magic_rank);
            var int = parseInt(v.int_base) + parseInt(v.int_training) + parseInt(v.int_ageing) + parseInt(v.int_other) + parseInt(v.int_temp);
            var reductionmod = 0;
            var basememorizemax = 0;
            var memorizemod = 0;
            if ( (v.divine_caster_class == "cleric") || (v.divine_caster_class == "druid")) {
                reductionmod = 2;
                memorizemod = 2;
                basememorizemax = Math.ceil(int/4);
            } else if (v.divine_caster_class == "bard") {
                reductionmod = 1;
                memorizemod = 1;
                basememorizemax = Math.ceil(int/6);
            } else if ((v.divine_caster_class == "paladin") || (v.divine_caster_class == "ranger")) {
                reductionmod = 1;
                memorizemod = 1;
                basememorizemax = Math.ceil(int/6);
    ...
    on("change:encounter_generator_json", function() {
        getAttrs(["encounter_generator_json", "simplified_combat_enabled"], function(v) {
            var simplified_combat_enabled = parseInt(v.simplified_combat_enabled);
            var jsonData = JSON.parse(v.encounter_generator_json);
